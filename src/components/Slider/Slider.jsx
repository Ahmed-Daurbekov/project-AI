...
const Slider = () => {
  ...
  function dotsCount() {
    ...
    // console.log(Math.ceil(slider.current.offsetWidth / (slider.current.querySelector('.card').offsetWidth + 35)));
  }
  ...
  function scrollLeft(e, number) {
    ...
    // else if (number == 1) {
    //   sliderLine.current.style.left = `-${slider.current.offsetWidth + 40}px`
    // } else if (number == 2) {
    //   sliderLine.current.style.left = `-${slider.current.offsetWidth * 2 + 120}px`
    // }
  }
  let dotArr = []
